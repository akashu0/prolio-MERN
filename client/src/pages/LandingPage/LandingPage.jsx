  ...
  return (
    <>
      <div className=" w-full h-full z-0 ">
        {/*Banner Section */}
        <div
          className="bg-blue-400 w-5/6 ml-20 mt-4 rounded-xl h-[300px] realtive"
          style={{
        ...
        {/* Section 2 */}
        <div className="w-5/6 bg-transparent h-[200px] ml-20 mt-6 gap-8 flex">
          <div className="w-1/2 bg-white rounded-xl flex">
            <div className="w-[280px] bg-white h-full pt-7">
              <span className="px-7 text-xl font-bold text-blue-950 bg-transparent">
                Join in Forums
              </span>
              <p className="pt-3 px-7 font-semibold text-sm text-blue-950 bg-transparent">
        ...
        <div
          className="w-5/6 bg-white ml-20 mt-4 h-auto rounded-xl  "
        ...
        >
          <div className="w-full bg-transparent pt-7 px-6 ">
            ...
            {/* <div className="mt-5 bg-transparent w-72 min-h-[10rem] rounded-lg  shadow-xl  overflow-hidden">
              <img
                className="w-full h-[200px]  object-cover"
                src={productData[0]?.sections1?.productImage[0]?.base64 || ""}
              />
              <div className="p-5 flex-col gap-3">
                ...
                <div className="pt-3 text-blue-800 font-semibold">
                    <span className="text-lg block">By</span>

                    <p className="mt-2 font-bold">Price : ₹ / piece</p>

                </div>
                <div className="w-full pt-3">
                    <button className="bg-blue-900 h-10 rounded-xl text-white  font-semibold w-full">Send Enquiry</button>
                </div>
              </div>

            </div> */}

            <div className="grid grid-cols-1 bg-transparent md:grid-cols-3 gap-5">
