...
function EnquiriesModal({ visible, onClose, data }) {
  ...
  const companyId = data?.companyId._id || "";
  ...
  const handleSubmit = async (e) => {
    ...
    if (productId && value.trim()) {
      try {
        if (enquiryValue?._id) {
          // If enquiryValue has an _id property, call the updateEnquiry endpoint
          ...
          // If enquiryValue doesn't have an _id property, call the create-enquiry endpoint
          const response = await axios.post(
            `${apiURL}/enquiry/create-enquiry`,
            {
              productId: productId,
              text: value,
              companyId: companyId,
        ...
        console.error("Error creating/updating enquiry:", error.message);
      }
    }
  };
    ...
    const fetchData = async () => {
      try {
        const response = await axios.get(
          `${apiURL}/enquiry/getByIdEnquiry/${productId}`,
          {
            headers: {
              Authorization: `Bearer ${token}`,
            },
        ...
        console.log(enquiryValue, "value.....................");
      } catch (error) {
